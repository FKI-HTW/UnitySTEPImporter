...
namespace ventus {
	...
	// GLOBAL CONSTANTS
	static const Standard_Integer TRANSFORMATION_ROW_NUMBER = 3;
	static const Standard_Integer TRANSFORMATION_COL_NUMBER = 4;
	...
	public:
		...
		static Quantity_ColorRGBA findColor(const TDF_Label& label);
